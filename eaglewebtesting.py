...
def banner():
    ...
    print("║      ██████   ██       ██   ██     ██      ██████                ║")
    print("║                                                                    ║")
    print("║                    WEB STRESS TESTER v3.0                         ║")
    print("║                      EAGLE TOOL - ELITE                          ║")
    print("╚════════════════════════════════════════════════════════════════════╝")
    print(nc)
...
def main():
    ...
    try:
        ...
        print(hijau + "╠════════════════════════════════════════════════════════════════╣" + nc)
        print(hijau + "║  ⚠️   Untuk testing website sendiri / izin resmi saja          ║" + nc)
        print(hijau + "║  🛡️  Bertanggung jawab & Gunakan secara etis!                 ║" + nc)
        print(hijau + "╚════════════════════════════════════════════════════════════════╝" + nc)
